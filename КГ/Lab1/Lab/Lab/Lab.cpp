...
bool createShaderProgram()
{
    ...
    const GLchar fsh[] =
        ...
        "void main()"
        "{"
        "   o_color = vec4(sign(sin(v_color[1] * 4 * 3.141)), 0.0, 0.0, 0.0);"
        "}"
        ;
#elif SHADER == 2
    ...
    const GLchar fsh[] =
        ...
        "   o_color = vec4(sign(sin(sqrt(x*x + y*y) * 30 * 3.141)), 0.0, 0.0, 0.0);"
        "}"
        ;
#else
    //волнистый рисунок
    const GLchar fsh[] =
        ...
        "   float x = v_color[0];"
        "   float y = v_color[1];"
        "   o_color = vec4(sign(sin(y * 20 * 3.141 + sin(x * 5 * 3.141) * 5)), 0.0, 0.0, 0.0);"
        "}"
        ;
#endif
